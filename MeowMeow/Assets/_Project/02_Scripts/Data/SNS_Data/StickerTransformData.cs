...
public struct StickerTransformData
{
    ...
    public double RelativeX ;     // 상대적인x좌표 (0.0 ~1.0)
    public double RelativeY ;     // 상대적인y좌표 (0.0 ~1.0)
    public double RelativeScale ; // 상대적인 크기 비율
    public double Rotation;      // z축 회전 값
}
[Serializable]
...
public class FirestoreStickerData
{
    ...
    public FirestoreStickerData() { }

    public FirestoreStickerData(StickerTransformData data)
    {
    ...
    public StickerTransformData ToStruct()
    {
        return new StickerTransformData
        {
...
[System.Serializable]
[FirestoreData] //  파이어스토어 변환기 활성화
public class FirestoreShaderProperty
{
    ...
    public FirestoreShaderProperty() { }

    public FirestoreShaderProperty(UIShaderProperty data)
    {
    ...
    public UIShaderProperty ToStruct()
    {
        return new UIShaderProperty
        {
